...
resource "aws_route53_record" "ses_smpt_record" {
  zone_id = var.smpt_hosted_zone_id
  name    = var.smtp_record_set_name
  type    = "CNAME"
  ttl     = "300"
  records = [aws_vpc_endpoint.ses_endpoint.dns_entry[0]["dns_name"]]
}
